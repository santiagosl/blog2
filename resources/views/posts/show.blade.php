        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">   
            ...
            <div class="lg:col-span-2">
                ...
                <figure>
                    ...
                    @else
                        <img class="w-full h-80 object-cover object-center" src="https://cdn.pixabay.com/photo/2022/06/14/00/22/mountain-7260827_960_720.jpg" alt="">
                    @endif
                </figure>
                    ...
                    @foreach ($similares as $similar)
                        ...
                        <li class="mb-4">
                            <a class="flex" href="{{route('posts.show', $similar)}}">
                                ...
                                @else
                                    <img class="w-36 h-20 object-cover object-center" src="https://cdn.pixabay.com/photo/2022/06/14/00/22/mountain-7260827_960_720.jpg" alt="">
                                @endif
